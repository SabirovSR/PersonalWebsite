...
class Settings(BaseSettings):
    ...
    cors_origins: str = (
        "https://sabirov.tech,https://web.sabirov.tech,http://localhost:3000,http://127.0.0.1:3000"
    )
    ...
    kafka_bootstrap_servers: str = (
        "kafka-controller-1:9092,kafka-controller-2:9092,kafka-controller-3:9092"
    )
